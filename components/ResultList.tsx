...
import { fetchTrademarks } from '../services/trademarkService'; // Assuming you have a service to fetch data based on the filter
      ...
      {Array.isArray(data) && data.length === 0 ? (
        ...
        <div className='bg-white shadow-sm p-5 rounded-md'>
          ...
          <div className='p-4 px-2 rounded-md w-max' style={{backgroundColor : "#f1f1f1"}}>
            <span className='rounded-md bg-white p-3 cursor-pointer'>List View</span>
            <span className='rounded-md p-3 cursor-pointer'>Grid View</span>
          </div>
